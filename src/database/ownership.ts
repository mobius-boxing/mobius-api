...
export const DOMAIN_OWNER: Record<string, DbKey> = {
  ...
  corrugations: "tenant",
  corrugator_plans: "tenant",
  corrugator_plan_orders: "tenant",
  corrugator_plan_combinations: "tenant",
  corrugator_plan_items: "tenant",
...
export const TABLE_MODULE: Record<string, "core" | "countdown" | "node-files"> =
  {
    ...
    corrugations: "core",
    corrugator_plans: "core",
    corrugator_plan_orders: "core",
    corrugator_plan_combinations: "core",
    corrugator_plan_items: "core",

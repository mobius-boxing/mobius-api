...
/**
 * Server mirror of `mobius-web-app/src/validation/schemas/complement.ts`.
 *
 ...
 * (AMENDMENT A1):
 *   complements.code        varchar(50) NOT NULL
 ...
 */
export const COMPLEMENT_LIMITS = {
  code: 50,
  description: 10000,
};
  ...
  public build(): this {
    collect((field) => {
      this.code = field("code", () =>
        codeText(this.code, COMPLEMENT_LIMITS.code, COMPLEMENT_LABELS.code),
      );
      this.description = field("description", () =>
        clearableText(
          this.description,
          COMPLEMENT_LIMITS.description,
          COMPLEMENT_LABELS.description,
        ),
      );
    });

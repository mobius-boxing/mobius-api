...
/**
 * Server mirror of `mobius-web-app/src/validation/schemas/strappingType.ts`.
 *
 ...
 * (AMENDMENT A1):
 *   strapping_types.code        varchar(50) NOT NULL
 *   strapping_types.description text        NULL
 *
 ...
 */
export const STRAPPING_TYPE_LIMITS = {
  code: 50,
  description: 10000,
};

export const STRAPPING_TYPE_LABELS = {
  code: "El código",
  ...
  public build(): this {
    collect((field) => {
      this.code = field("code", () =>
        codeText(
          this.code,
          STRAPPING_TYPE_LIMITS.code,
          STRAPPING_TYPE_LABELS.code,
        ),
      );
      this.description = field("description", () =>
        clearableText(
          this.description,
          STRAPPING_TYPE_LIMITS.description,
          STRAPPING_TYPE_LABELS.description,
        ),
      );
    });

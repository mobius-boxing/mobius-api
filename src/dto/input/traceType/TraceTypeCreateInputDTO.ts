...
/**
 * Server mirror of `mobius-web-app/src/validation/schemas/traceType.ts`.
 *
 ...
 * (AMENDMENT A1):
 *   trace_types.code        varchar(50) NOT NULL
 *   trace_types.description text        NULL
 *
 ...
 */
export const TRACE_TYPE_LIMITS = {
  code: 50,
  description: 10000,
};
  ...
  public build(): this {
    collect((field) => {
      this.code = field("code", () =>
        codeText(this.code, TRACE_TYPE_LIMITS.code, TRACE_TYPE_LABELS.code),
      );
      this.description = field("description", () =>
        clearableText(
          this.description,
          TRACE_TYPE_LIMITS.description,
          TRACE_TYPE_LABELS.description,
        ),
      );
    });

...
/**
 * Server mirror of `mobius-web-app/src/validation/schemas/flapType.ts`.
 *
 ...
 * (AMENDMENT A1):
 *   flap_types.code        varchar(50) NOT NULL
 ...
 */
export const FLAP_TYPE_LIMITS = {
  code: 50,
  description: 10000,
};

export const FLAP_TYPE_LABELS = {
  code: "El código",
  ...
  public build(): this {
    collect((field) => {
      this.code = field("code", () =>
        codeText(this.code, FLAP_TYPE_LIMITS.code, FLAP_TYPE_LABELS.code),
      );
      this.description = field("description", () =>
        clearableText(
          this.description,
          FLAP_TYPE_LIMITS.description,
          FLAP_TYPE_LABELS.description,
        ),
      );
    });

...
/**
 * Server mirror of `mobius-web-app/src/validation/schemas/corrugationClass.ts`.
 *
 ...
 * (AMENDMENT A1):
 *   corrugation_classes.code        varchar(50) NOT NULL
 ...
 */
export const CORRUGATION_CLASS_LIMITS = {
  code: 50,
  description: 10000,
};

export const CORRUGATION_CLASS_LABELS = {
  code: "El código",
  ...
  public build(): this {
    collect((field) => {
      this.code = field("code", () =>
        codeText(
          this.code,
          CORRUGATION_CLASS_LIMITS.code,
          CORRUGATION_CLASS_LABELS.code,
        ),
      );
      this.description = field("description", () =>
        clearableText(
          this.description,
          CORRUGATION_CLASS_LIMITS.description,
          CORRUGATION_CLASS_LABELS.description,
        ),
      );
    });

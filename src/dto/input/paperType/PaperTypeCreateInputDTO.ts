...
/**
 * Server mirror of `mobius-web-app/src/validation/schemas/paperType.ts`.
 *
 ...
 * (AMENDMENT A1):
 *   paper_types.code        varchar(50) NOT NULL
 ...
 */
export const PAPER_TYPE_LIMITS = {
  code: 50,
  description: 10000,
};
  ...
  public build(): this {
    collect((field) => {
      this.code = field("code", () =>
        codeText(this.code, PAPER_TYPE_LIMITS.code, PAPER_TYPE_LABELS.code),
      );
      this.description = field("description", () =>
        clearableText(
          this.description,
          PAPER_TYPE_LIMITS.description,
          PAPER_TYPE_LABELS.description,
        ),
      );
    });

...
describe('CompanyDAO', () => {
  ...
  describe('create', () => {
    ...
    it('should set default value for isActive to true', async () => {
      ...
      mockQueryBuilder.returning.mockResolvedValue([{ ...testData, isActive: true }]);
  ...
  describe('update', () => {
    it('should update company by numeric ID', async () => {
      const testData = createTestCompany();
      const updatedData = { ...testData, name: 'Updated Company', description: 'Updated description' };
    ...
    it('should update isActive status', async () => {
      const testData = createTestCompany();
      mockQueryBuilder.returning.mockResolvedValue([{ ...testData, isActive: false }]);
